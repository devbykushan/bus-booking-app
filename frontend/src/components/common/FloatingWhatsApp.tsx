...
export const FloatingWhatsApp: React.FC = () => {
  ...
  return (
    <div className="fixed bottom-[calc(4.1rem+max(0.2rem,calc(env(safe-area-inset-bottom,0px)*0.1)))] md:bottom-6 right-3 sm:right-6 z-40 flex flex-col items-end select-none font-sans" ref={menuRef}>
