...
export const Navbar: React.FC = () => {
  ...
  return (
    <>
      ...
      <div className="md:hidden fixed bottom-[max(0.2rem,calc(env(safe-area-inset-bottom,0px)*0.1))] left-0 right-0 z-[100] px-3 pointer-events-none flex justify-center">
        <nav
