  ...
  return (
    <>
      <div 
        ...
        className={`bg-white rounded-3xl p-6 border transition-all duration-300 relative shadow-sm hover:shadow-md cursor-pointer ${
      ...
      >
        ...
        <div className="py-5 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6">
          ...
          <div className="space-y-1">
            ...
            <span className="inline-block px-2 py-0.5 rounded bg-slate-100 text-slate-500 text-[10px] font-extrabold uppercase tracking-wider">
              DEPARTURE
            </span>
          ...
          <div className="flex flex-col items-center justify-center w-full sm:w-auto px-2">
            <div className="flex items-center gap-2 w-full justify-center">
              <div className="h-[1px] w-12 sm:w-16 bg-slate-300 relative">
                <div className="w-1.5 h-1.5 rounded-full bg-slate-400 absolute -top-[2.5px] left-0" />
              </div>
              <span className="px-3 py-1 rounded-full bg-slate-100 border border-slate-200 text-slate-600 text-xs font-bold font-mono flex-shrink-0 shadow-xs">
                {route.duration || '6h 00m'}
              </span>
              <div className="h-[1px] w-12 sm:w-16 bg-slate-300 relative flex items-center justify-end">
